...
public class BookitUtils {
    ...
    public static String generateToken(String email, String password) {
        ...
        // without enviroment class:
        // .get(ConfigurationReader.getProperty("base_url") + "/sign");
    ...
    public static String generateTokenByRole(String role) {
        ...
        Response response = given().queryParams(returnCredentials(role))
                .when().get(Environment.BASE_URL + "/sign").prettyPeek();
